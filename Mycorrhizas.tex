...
\PaperTitle{On va tout niquer grâce à rmakdonee} % Article title

\Authors{
Elia Dardevet\textsuperscript{1*}\\ Victor Vacher\textsuperscript{2}
} % Authors
\affiliation{
...
\Keywords{mycorrhizas, trees, tropical forests} % Keywords - if you don't want any simply remove all the text between the curly brackets
...
\Abstract{
Wallah frro on a fait un truc lourd lis tu verra tu vas kiffer (c'est sur les champipi dans la forêt quand il pleut plus)
}
